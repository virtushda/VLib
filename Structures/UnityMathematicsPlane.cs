...
namespace VLib
{
    ...
    [Serializable]
    public struct UnityMathematicsPlane
    {
        /// <summary>
        ...
        public UnityMathematicsPlane(float coefficientA, float coefficientB, float coefficientC, float coefficientD)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UnityMathematicsPlane(float3 normal, float distance)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UnityMathematicsPlane(float3 normal, float3 pointInPlane)
        ...
        /// <param name="pointInPlane">A point that lies in the plane.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UnityMathematicsPlane(float3 vector1InPlane, float3 vector2InPlane, float3 pointInPlane)
        ...
        /// </summary>
        /// <remarks>
        /// If you have a unit length normal vector, you can create a UnityMathematicsPlane faster than using one of its constructors
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnityMathematicsPlane CreateFromUnitNormalAndDistance(float3 unitNormal, float distance)
        {
            return new UnityMathematicsPlane { NormalAndDistance = new float4(unitNormal, distance) };
        }
        ...
        /// <returns>Normalized Plane constructed from given inputs.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnityMathematicsPlane CreateFromUnitNormalAndPointInPlane(float3 unitNormal, float3 pointInPlane)
        {
            return new UnityMathematicsPlane { NormalAndDistance = new float4(unitNormal, -math.dot(unitNormal, pointInPlane)) };
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UnityMathematicsPlane Normalize(UnityMathematicsPlane plane)
        {
            return new UnityMathematicsPlane { NormalAndDistance = Normalize(plane.NormalAndDistance) };
        }
        ...
        public static float4 Normalize(float4 planeCoefficients)
        {
            ...
            return new UnityMathematicsPlane { NormalAndDistance = planeCoefficients * recipLength };
        }
        ...
        /// </summary>
        public UnityMathematicsPlane Flipped => new UnityMathematicsPlane { NormalAndDistance = -NormalAndDistance };
