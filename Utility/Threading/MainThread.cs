...
namespace VLib.Threading
{
    public static class MainThread
    {
        ...
        static void EditorInit() => CaptureMainThreadID();
#endif
        
        [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.SubsystemRegistration)]
        static void RuntimeInit() => CaptureMainThreadID();

        static void CaptureMainThreadID() => mainThreadId = Thread.CurrentThread.ManagedThreadId;
...
#if UNITY_EDITOR
            if (mainThreadId == -1)
                Debug.LogError("MainThread.OnMain was called before the main thread ID was captured! Result of this method may be wrong!");
#endif
