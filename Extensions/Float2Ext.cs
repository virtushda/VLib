...
namespace VLib
{
    public static class Float2Ext
    {
        ...
        public static float3 ToFloat3_SupplyX(this float2 vec, float newXValue) => new(newXValue, vec);
        
        /// <summary> Turn a float2 into a float3, where the float2 becomes float3.xz and you supply 'y' </summary>
        public static float3 ToFloat3_SupplyY(this float2 vec, float newYValue) => new(vec.x, newYValue, vec.y);
        
        /// <summary> Turn a float2 into a float3, where the float2 becomes float3.xy and you supply 'z' </summary>
        public static float3 ToFloat3_SupplyZ(this float2 vec, float newZValue) => new(vec, newZValue);
